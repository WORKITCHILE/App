...
public class SwipeButton extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        background.setBackground(ContextCompat.getDrawable(context, R.drawable.ic_btn_swipe_bg));

        addView(background, layoutParamsView);
        //Text
        final TextView centerText = new TextView(context);
        centerText.setTag("swipeText");
        ...
        disabledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_swipe_lock);
        enabledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_swipe_lock);
        ...
        swipeButton.setBackground(ContextCompat.getDrawable(context, R.drawable.ic_btn_swipe));
    ...
    private void swipeToUnlock(MotionEvent event) {
        if (initialX == 0) {
