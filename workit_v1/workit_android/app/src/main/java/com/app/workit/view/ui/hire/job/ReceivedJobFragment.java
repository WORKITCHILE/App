...
public class ReceivedJobFragment extends MainBaseFragment implements IAdapterItemClickListener {
    private static final int RC_JOB_INFO = 45;
    private static final int RC_EVALUATE = 8;
    ...
    public static ReceivedJobFragment newInstance() {

        Bundle args = new Bundle();

        ReceivedJobFragment fragment = new ReceivedJobFragment();
    ...
    private void initJobs() {
        ...
        postJobListAdapter = new PostJobListAdapter(getmContext(), userInfo, AppConstants.USER_TYPE.WORK, AppConstants.USER_TYPE.HIRE_INFO);
