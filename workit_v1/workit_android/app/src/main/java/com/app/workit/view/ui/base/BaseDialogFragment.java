...
public abstract class BaseDialogFragment extends DaggerDialogFragment implements BaseView {
    ...
    public void showErrorPrompt(String error) {
        Toast toast = FancyToast.makeText(mContext, error, FancyToast.LENGTH_SHORT, FancyToast.ERROR, false);
